...
informacion_personal["ciudad"] = "Rusia"  # Cambiar la ciudad a Barcelona
...
if "numero de celular" not in informacion_personal:
    informacion_personal["numero de celular"] = "0980185424"  # Agregar un número de teléfono ficticio
